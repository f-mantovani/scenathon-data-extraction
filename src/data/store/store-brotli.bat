...
set "source_folder=C:\Users\Felipe\Desktop\learning\scenathon-backend\src\data\store"

rem Specify the target folder where Brotli compressed files will be placed
set "target_folder=C:\Users\Felipe\Desktop\learning\scenathon-backend\src\data\store\brotli"
