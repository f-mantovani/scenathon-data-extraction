    ...
    file.forEach((el: Base, i: number) => {
          ...
          el.legend = [
            {
              ...
              description:
                "Forest losses are driven by cropland, pasture and/or urban expansion and forest gains by due to afforestation or reforestation. Net forest change is the sum of gains and losses in total forest cover. Results are given per 5-year periods (2005 corresponds to years 2001 to 2005).",
            },
            {
              key: "Forest gain",
              color: colors.gain,
      ...
      if (year == 2020 || year == 2021) {
          ...
          el.legend = [
            {
              label: "Figure description",
              description:
                "The figure show the evolution of land cover over the period.",
            },
            {
              key: "Pasture",
        ...
        if (i == 1) {
          ...
          el.description =
            "Evolution of land under protected areas (PA), from 2000 to 2050 differentiating per land cover type";
          el.axisY = "Million hectares";
          el.notes =
          ...
          el.legend = [
            {
              label: "Figure description",
              description:
                "The figure show the total land under protected areas as reported by WDPA.",
            },
            {
              key: "Forest",
              color: colors.forest,
      ...
      if (year == 2023) {
          ...
          el.legend = [
            {
              label: "Figure description",
              description:
                "The figure show the total land under protected areas or Other Effectice Conservation Measures (OECM) as reported by WDPA. We do not disagregate OECM per land cover type. According to the Kunming-Montreal Global Biodiversity Framework, we should aim at 30% of terristerial land under PA or OECM by 2030.",
            },
            {
              key: "Forest",
              color: colors.forest,
          ...
          el.legend = [
            {
              label: "Figure description",
              description:
                "Mature forest refers to forest areas that were already present in 2000. The global objective is to have zero deforestation in mature forest areas from 2030 onwards. In the FABLE Calculator, forest loss is driven by cropland, pasture and/or urban expansion.",
            },
            {
              key: "Mature forests",
              color: colors.mature,
        ...
        if (i == 3) {
          ...
          el.description =
            "Evolution of total cropland area, both under conventional and agroecological practices";
          el.notes =
            "Baseline data on agroecological practices coverage is made by FABLE, please refer to the Agroecology module documentation (2024) for more information.";
          el.legend = [
            {
              label: "Figure description",
              description:
                "Agroecological practices is an umbrella term for any practice that is distinct from intensively managed monocultures such as cover crops, cultivar mixtures, embedded natural land, reduced tillage, organic farming or a mix of them. In our model, agroecological practice coverage is expressed as a percentage of total cropland. According to the Kunming-Montreal Global Biodiversity Framework, we should aim at 50% of cropland area managed under biodierversity-friendly practices 2030.",
            },
            {
              ...
              inLegend: true,
              description:
                "Cropland area managed under agroecological practices",
            },
            {
          ...
          el.data = el.data.map(e => ({
            valueX: e.valueX,
            location: e.location,
            'Agroecological practices': e['agroeco_cropland'],
            'Conventional practices': e['not_agroeco_cropland'],
            targets: e.targets
          }))
